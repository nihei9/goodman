...
int good_append_prule(good_ProductionRules *prules, good_SymbolID lhs, const good_SymbolID *rhs, size_t rhs_len);
...
good_ProductionRuleFilter *good_set_prule_filter_by_lhs(good_ProductionRuleFilter *filter, good_SymbolID lhs);
