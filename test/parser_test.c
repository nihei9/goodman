...
void test_1(connie_Connie *c)
{
    ...
    A_EQL_STRING(c, "E", syms_lookup(syms, prule_lhs_ast->token.value.symbol_id));
    // : E '+' T
    ...
    A_EQL_STRING(c, "E", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    A_NOT_NULL(c, prule_rhs_elem_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS_ELEM_STRING, prule_rhs_elem_ast->type);
    A_EQL_STRING(c, "+", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    A_NOT_NULL(c, prule_rhs_elem_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS_ELEM_SYMBOL, prule_rhs_elem_ast->type);
    A_EQL_STRING(c, "T", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    ...
    A_NOT_NULL(c, prule_lhs_ast);
    A_EQL_INT(c, good_AST_PRULE_LHS, prule_lhs_ast->type);
    A_EQL_STRING(c, "T", syms_lookup(syms, prule_lhs_ast->token.value.symbol_id));
    // : T '*' F
    prule_rhs_ast = prule_lhs_ast->brother;
    A_NOT_NULL(c, prule_rhs_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS, prule_rhs_ast->type);
    ...
    A_NOT_NULL(c, prule_rhs_elem_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS_ELEM_SYMBOL, prule_rhs_elem_ast->type);
    A_EQL_STRING(c, "F", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    A_NULL(c, prule_rhs_elem_ast);
    // | F
    prule_rhs_ast = prule_rhs_ast->brother;
    ...
    A_NOT_NULL(c, prule_lhs_ast);
    A_EQL_INT(c, good_AST_PRULE_LHS, prule_lhs_ast->type);
    A_EQL_STRING(c, "F", syms_lookup(syms, prule_lhs_ast->token.value.symbol_id));
    // : '(' E ')'
    prule_rhs_ast = prule_lhs_ast->brother;
    A_NOT_NULL(c, prule_rhs_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS, prule_rhs_ast->type);
    ...
    A_NOT_NULL(c, prule_rhs_elem_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS_ELEM_SYMBOL, prule_rhs_elem_ast->type);
    A_EQL_STRING(c, "id", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    A_NULL(c, prule_rhs_elem_ast);
    ...
    A_NOT_NULL(c, prule_lhs_ast);
    A_EQL_INT(c, good_AST_PRULE_LHS, prule_lhs_ast->type);
    A_EQL_STRING(c, "id", syms_lookup(syms, prule_lhs_ast->token.value.symbol_id));
    // : '[a-zA-Z_][a-zA-Z0-9_]*'
    prule_rhs_ast = prule_lhs_ast->brother;
    A_NOT_NULL(c, prule_rhs_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS, prule_rhs_ast->type);
    ...
    A_NOT_NULL(c, prule_rhs_elem_ast);
    A_EQL_INT(c, good_AST_PRULE_RHS_ELEM_STRING, prule_rhs_elem_ast->type);
    A_EQL_STRING(c, "[a-zA-Z_][a-zA-Z0-9_]*", syms_lookup(syms, prule_rhs_elem_ast->token.value.symbol_id));
    prule_rhs_elem_ast = prule_rhs_elem_ast->brother;
    A_NULL(c, prule_rhs_elem_ast);
